...
namespace CYGameplayTags
{
	...
	// Montage 재생 상태
	CATCHMEIFYOUCAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_Animation_Montage_ClimbingLadder);
	
	CATCHMEIFYOUCAN_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Status_HitReact);
