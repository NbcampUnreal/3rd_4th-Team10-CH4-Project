...
#include "CYAbilityTask_WaitInputStart.generated.h"
 ...
 * 2. CYAbilitySystemComponent::AbilitySpecInputStarted()에서 이벤트 발생
...
*/
UCLASS()
class CATCHMEIFYOUCAN_API UCYAbilityTask_WaitInputStart : public UAbilityTask
{
	GENERATED_BODY()

public:
	UCYAbilityTask_WaitInputStart(const FObjectInitializer& ObjectInitializer);
	
	UFUNCTION(BlueprintCallable, Category="Ability|Tasks", meta=(HidePin="OwningAbility", DefaultToSelf="OwningAbility", BlueprintInternalUseOnly="true"))
	static UCYAbilityTask_WaitInputStart* WaitInputStart(UGameplayAbility* OwningAbility);
