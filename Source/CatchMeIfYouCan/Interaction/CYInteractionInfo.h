...
#include "CYInteractionInfo.generated.h"
...
public:
	...
	/** 상호작용 UI에 표시될 제목 (예: "문 열기", "체포 하기") */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FText Title;

	/** 상호작용 UI에 표시될 상세 설명 (예: "R키를 눌러 문을 엽니다") */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	FText Content;
	 ...
	 * 플레이어의 Resourcefulness 스탯에 의해 단축될 수 있음
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite)
	float Duration = 0.f;
	 ...
	 * 상호작용 정보 변화 감지에 사용
	 */
	FORCEINLINE bool operator==(const FCYInteractionInfo& Other) const
	{
